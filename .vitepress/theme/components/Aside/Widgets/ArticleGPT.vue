...
<template>
  <div v-if="frontmatter.articleGPT" class="article-gpt s-card">
    ...
    <div class="meta">
      <span class="tip">此内容根据文章生成，仅用于文章内容的解释与总结</span>
      <a
...
const showOther = () => {
  ...
  const text =
    "我是摘要生成助理 FakeGPT，如你所见，这是一个假的 GPT，所有文本皆源于本地书写的内容。我在这里只负责显示，并仿照 GPT 的形式输出，如果你像我一样囊中羞涩，你也可以像我这样做，当然，你也可以使用 Tianli 开发的 TianliGPT 来更简单地实现真正的 AI 摘要。";
  showIndex.value = 0;
  loading.value = true;
  abstractData.value = "";
  if (!showType.value) {
